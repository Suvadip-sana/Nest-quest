...
module.exports.isLoggedIn = (req, res, next) => {
    if(!req.isAuthenticated()){ // Check if the user logged in or not before creating new listing with the help of 'isAuthenticated()' inbuilt method by passport,
...
module.exports.validateListing = (req, res, next) => {
    ...
    if (error) {
        ...
        //throw it's error message along with 400 status code
